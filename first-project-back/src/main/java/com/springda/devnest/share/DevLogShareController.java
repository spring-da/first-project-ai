...
@RestController
@RequestMapping("/api/v1/logs/{resourceId}/shares")
public class DevLogShareController {
    private final KnowledgeShareService shares;

    public DevLogShareController(KnowledgeShareService shares) {
        this.shares = shares;
    }
    ...
    List<KnowledgeShareDtos.SummaryResponse> list(
        ...
        return shares.list(ownerId, KnowledgeResourceType.DEV_LOG, resourceId);
    }
    ...
    ResponseEntity<KnowledgeShareDtos.SecretResponse> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                ...
                .body(shares.create(ownerId, KnowledgeResourceType.DEV_LOG, resourceId, request));
    }
    ...
    void revoke(
        ...
        shares.revoke(ownerId, KnowledgeResourceType.DEV_LOG, resourceId, shareId);
    }
}
