...
import { apiDownload, apiRequest, readStoredSession } from '../src/services/api.ts'
...
beforeEach(() => {
  ...
  Object.defineProperty(globalThis, 'localStorage', { configurable: true, value: {
    getItem: () => JSON.stringify({ accessToken: 'admin-token', tokenType: 'Bearer', user: { id: 'admin', role: 'ADMIN' } }), removeItem: () => {},
  } })
})
